...
/*
 * format for courses
 * will be removed when implemented into nebula web
*/
...
//maybe I could use the gpa data from nebula web and reconfigure the coloring algo
const letters = {'A+': 1, 'A': 1.25, 'A-': 1.5, 'B+': 2, 'B': 2.25, 'B-': 2.5, 'C+': 3.5, 'C': 4, 'C-': 4.5, 'D+': 5.5, 'D': 6, 'D-': 6.5, 'F': 15, 'W': 16}
...
function returnYears() {
  ...
  var max = currentYear - 1970;
  var years = Array.from(Array(max).keys());
    ...
    >
      {(() => {
        if (adding) {
          return (
            <div id="wrapper">
              <TextField id="course" type="course" name="Course" placeholder="Enter Course Name" onChange={ handleChange }></TextField>
              <FormControl className="wider">
                  <InputLabel shrink={true} id="year">Year</InputLabel>
                  <Select
                    labelId="year"
                    id="year"
                    value={year}
              ...
              <FormControl className="wider">
                  <InputLabel shrink={true} id="season">Season</InputLabel>
                  <Select
                    labelId="season"
                    id="season"
                    value={season}
              ...
              <FormControl className="wider">
                  <InputLabel shrink={true} id="grade">Grade</InputLabel>
                  <Select
                    labelId="grade"
                    id="grade"
                    value={grade}
...
function colorMeBlue(grade) {
  ...
  return "rgb("+Math.round(255-(1020/(index+4)))+","+Math.round(1020/(index+4))+",64)";
}
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected.length} data={rows} update={setRows} updateNum={setSelected}/>
        <TableContainer>
          <Table
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" style={{color: colorMeBlue(row.grade)}}>{row.grade}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
